...
def meta_size_sorting_core(sorting_func):
    count_file = 0
...
def sort_by_size():
    meta_size_sorting_core(size_sorting_func)


def sort_by_date_modified():
    meta_size_sorting_core(date_modified_sorting_func)


def sort_by_date_created():
    meta_size_sorting_core(date_created_sorting_func)
...
rash_checkbutton = Radiobutton(text="Extension", value=0, variable=lang, padx=15, pady=10)
rash_checkbutton.place(x = 0, y = 50)

abs_checkbutton = Radiobutton(text="1st letter", value=1, variable=lang, padx=15, pady=10)
abs_checkbutton.place(x = 100, y = 50)

size_checkbutton = Radiobutton(text="Size", value=2, variable=lang, padx=15, pady=10)
size_checkbutton.place(x = 200, y = 50)

sort_file = Button(root, text="Sort", bd = 2, relief = GROOVE, state=DISABLED, command = sort_final)
sort_file.place(x = 200, y = 90)
